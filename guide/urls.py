...
urlpatterns = [
    ...
    path('town_watch/<slug:slug>', town_watch_view, name='town_watch'),  # вывод конкретного города по запросу (что посмотреть)
    path('town_eat/<slug:slug>', town_eat_view, name='town_eat'),  # вывод конкретного города по запросу (где поесть)
    path('town_sleep/<slug:slug>', town_sleep_view, name='town_sleep'),  # вывод конкретного города по запросу (где поспать)
