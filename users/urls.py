...
from users.views import UserLogin, UserRegister, user_profile_view, UserRegisterStep2
...
urlpatterns = [
    ...
    path('register_next/', UserRegisterStep2.as_view(template_name='register_next.html'), name='register_next'),
]
